...
SECRET_KEY = 'django-insecure-p6yzq7m-=4y$2e#e9cy)203%k7jhl!dt9)&4bxn^-s%n^-epe!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['anthony-hospital-management.onrender.com', 'localhost']
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # This creates a static directory at the base of your project.
]


# Middleware
MIDDLEWARE = [
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Add this above SecurityMiddleware
    # other middlewares
]
